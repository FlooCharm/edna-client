...
const ManSilhouette = props => (
  <svg fill="none" viewBox='0 0 112.88 276.92'>
    <g clipPath="url(#prefix__clip0)" fill="black">
      ...
      <path
        stroke='#ebebeb'
        fill={props.neckColor}
        onClick={() => props.onNeckClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.rightArmColor}
        onClick={() => props.onRightArmClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.leftArmColor}
        onClick={() => props.onLeftArmClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.torsoColor}
        onClick={() => props.onTorsoClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.beltColor}
        onClick={() => props.onBeltClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.underwearColor}
        onClick={() => props.onUnderwearClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.rightLegColor}
        onClick={() => props.onRightLegClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.leftLegColor}
        onClick={() => props.onLeftLegClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.rightFootColor}
        onClick={() => props.onRightFootClick()}
      ...
      <path
        stroke='#ebebeb'
        fill={props.leftFootColor}
        onClick={() => props.onLeftFootClick()}
...
ManSilhouette.propTypes = {
  ...
  onNeckClick: PropTypes.func,
  onRightArmClick: PropTypes.func,
  onLeftArmClick: PropTypes.func,
  onTorsoClick: PropTypes.func,
  onBeltClick: PropTypes.func,
  onUnderwearClick: PropTypes.func,
  onRightLegClick: PropTypes.func,
  onLeftLegClick: PropTypes.func,
  onRightFootClick: PropTypes.func,
  onLeftFootClick: PropTypes.func
}
