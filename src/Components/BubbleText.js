...
export default function TextInput(props) { 
	return (
		<svg width={`${props.isPass ? '370': '333'}`} height="125" viewBox={`0 0 ${props.isPass ? '370': '333'} 125`} fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<g>
				...
				<text x="50%" y="31%" dominantBaseline="middle" textAnchor="middle" fontSize="36" fill="white">{props.text}</text>
			</g>
		</svg>
	)	
}
